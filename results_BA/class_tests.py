...
plt.title(
    ...
    "mit Softmax-Wahrscheinlichkeit > 0.75"
)
...
# Speichern
# =========================
png_path = os.path.join(output_dir, "class_distribution_linear.png")
eps_path = os.path.join(output_dir, "class_distribution_linear.eps")
