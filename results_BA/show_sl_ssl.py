...
def load_model(model_path, device, model_key=None):
    ...
    if isinstance(checkpoint, dict):
        ...
        elif "teacher_model_state" in checkpoint:
            state_dict = checkpoint["teacher_model_state"]
        elif "student_model_state" in checkpoint:
            state_dict = checkpoint["student_model_state"]
        else:
...
def main():
    ...
    ssl_model = load_model(SSL_MODEL_PATH, device, model_key="teacher_model_state")
